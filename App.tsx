...
const App: React.FC = () => {
    return (
        <div className="bg-[#FBF9F3] text-stone-800 relative overflow-x-hidden">
            {/* Decorative elements */}
            <img src="https://i.postimg.cc/3JKvyY4J/A-rbol.png" alt="" className="absolute -top-10 right-0 lg:w-1/5 w-1/3 opacity-30 mix-blend-multiply pointer-events-none -z-0" />
